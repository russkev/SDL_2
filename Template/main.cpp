...
void draw_animation_frame (SDL_Surface& s_surface, double s_absolute_time, double s_delta_time, const glm::mat4& projection, graphics::fps& frame_monitor) {
	...
	point_type max_y_vert_transformed = transform*max_y_vert.m_pos;
	point_type mid_y_vert_transformed = transform*mid_y_vert.m_pos;
	point_type min_y_vert_transformed = transform*min_y_vert.m_pos;
